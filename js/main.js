jQuery(document).ready(function($){
	...
	var date_string = year + ' 2025 ' + month + ' Feb' + day + ' 14'
	day_count = dateDiffInDays(new Date("14/02/2025"), new Date());
	document.getElementById('days').innerHTML = date_string + '，' + " " + day_count + " "
